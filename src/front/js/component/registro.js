            ...
            <div style={
                ...
                <form className="row g-3 mx-auto "
                    ...
                    <div className="col-md-6">
                        ...
                        <input type="text" className="form-control me-2" id="inputNombre" placeholder="Nombre "
                            value={nombre}
                            onChange={
                    ...
                    <div className="col-md-6">
                        ...
                        <input type="password" className="form-control me-2" id="inputPassword4" placeholder="Contraseña"
                            value={contraseña}
                            onChange={
                    ...
                    <div className="col-md-6">
                        ...
                        <input type="email" className="form-control me-2" id="inputEmail4" placeholder="Correo"
                            value={correo}
                            onChange={
                    ...
                    <div className="col-md-6">
                        ...
                        <input type="password" className="form-control me-2" id="inputPassword4" placeholder="Confirmar Contraseña"
                            value={confirmar}
                            onChange={
                    ...
                    <div className="col-md-6">
                        ...
                        <input type="tel" className="form-control me-2" id="inputCelular" placeholder="Celular"
                            value={celular}
                            onChange={
