    ...
    return {
        ...
        actions: {
            ...
            signup: (
                ...
                fetch(
                        "https://3001-agusalvs-salvandopatita-sywz3d0qel2.ws-us87.gitpod.io/api/registro", {
                            method: "POST",
                            headers: {
            ...
            login: (userEmail, userPassword) => {
                ...
                fetch(
                        "https://3001-agusalvs-salvandopatita-sywz3d0qel2.ws-us87.gitpod.io/api/autenticacion", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                // 'Content-Type': 'application/x-www-form-urlencoded',
            ...
            publicar: (
                ...
                const store = getStore();
                fetch(
                        "https://3001-agusalvs-salvandopatita-sywz3d0qel2.ws-us87.gitpod.io/api/publicacion/" +
                        store.user_id, {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
            ...
            enviarcorreo: (userCorreo) => {
                fetch(
                        "https://3001-agusalvs-salvandopatita-sywz3d0qel2.ws-us87.gitpod.io/api/recuperar-contraseña", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                // 'Content-Type': 'application/x-www-form-urlencoded',
            ...
            mascotasHome: () => {
                const store = getStore();
                fetch(
                        "https://3001-agusalvs-salvandopatita-sywz3d0qel2.ws-us87.gitpod.io/api/mascotas"
                    )
                    .then((res) => res.json())
            ...
            cambiar: (userContraseñagmail, userNuevacontraseña) => {
                ...
                fetch(
                        "https://3001-agusalvs-salvandopatita-sywz3d0qel2.ws-us87.gitpod.io/api/cambiar-contrasena/" +
                        ID, {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                 ...
                 */
                {
                    try {
                        const response = await axios.post(
                            "https://3001-agusalvs-salvandopatita-sywz3d0qel2.ws-us87.gitpod.io" +
